...
<script src="<?php echo base_url('assets/js/face-api.min.js'); ?>"></script>
  ...
  <div class="page-content-wrapper">
    ...
    data-bs-delay="60000" data-bs-autohide="true" id="installWrap">
      <div class="toast-body p-4">
        <div class="toast-text me-2">
          <h6 class="text-white">Welcome to Affan!</h6>
              ...
              <div class="card-body p-3">
                <div class="element-heading-wrapper">
                  ...
                  <div class="heading-text">
                    <h6 class="mb-1"><?php echo $hari?> <?php echo $tglnow?></h6>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="container direction-rtl">
      <div class="card mb-3">
        <div class="card-body">
              <label class="form-label" for="exampleInputText3">Lokasi Kantor</label>
              ...
              <label class="form-label" for="exampleInputText3"><p id="demo"></p></label>

              <button class="btn btn-primary w-100" onclick="daftarfaceid()">Daftar Face Id</button>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row g-3">
          ...
          <div class="col-6 col-sm-4 col-lg-3">
            <div class="card single-product-card" onclick="cek_in()">
              <div class="card-body p-3">
                <div class="element-heading-wrapper">
          ...
          <!-- Single Top Product Card -->
          <div class="col-6 col-sm-4 col-lg-3">
            <div class="card single-product-card" onclick="cek_out()">
              <div class="card-body p-3">
                <div class="element-heading-wrapper">
    ...
    <div id="modalCheckin" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background: rgba(0,0,0,0.7); justify-content:center; align-items:center; z-index:9999;">
        <div style="background:#fff; padding:20px; border-radius:10px; text-align:center; width:360px; position:relative;">
            ...
            <div style="margin-top:10px; display:flex; justify-content:center; gap:10px;">
                <button id="btn-checkin" style="flex:1; padding:8px; border:none; background-color:#007bff; color:white; border-radius:5px; cursor:pointer;">
                    CheckIn
                </button>
                <button id="btnCancel" style="flex:1; padding:8px; border:none; background-color:#6c757d; color:white; border-radius:5px; cursor:pointer;">
                    Batal
                </button>
            </div>
    ...
    <div id="modalCheckout" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background: rgba(0,0,0,0.7); justify-content:center; align-items:center; z-index:9999;">
        <div style="background:#fff; padding:20px; border-radius:10px; text-align:center; width:360px; position:relative;">
            ...
            <p id="msg" style="color:red; min-height:20px; margin-top:5px;"></p>
            <div style="margin-top:10px; display:flex; justify-content:center; gap:10px;">
                <button id="btn-checkout" style="flex:1; padding:8px; border:none; background-color:#007bff; color:white; border-radius:5px; cursor:pointer;">
                    CheckOut
                </button>
                <button id="btnCancelout" style="flex:1; padding:8px; border:none; background-color:#6c757d; color:white; border-radius:5px; cursor:pointer;">
                    Batal
                </button>
            </div>
